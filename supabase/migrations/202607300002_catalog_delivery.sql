alter table public.store_settings
  add column if not exists catalog_categories jsonb not null default
  '[
    {"id":"skin","label":"Skin care","subcategories":[]},
    {"id":"hair","label":"Hair care","subcategories":[]},
    {"id":"body","label":"Body care","subcategories":[]},
    {"id":"smile","label":"Smile care","subcategories":[]},
    ...
    {"id":"sun","label":"Sunscreens","subcategories":[]},
    {"id":"deodorant","label":"Deodorant","subcategories":[]},
    {"id":"acne","label":"Acne routines","subcategories":[]},
    {"id":"lash","label":"Lashes & brows","subcategories":[]},
    {"id":"lip","label":"Lip care","subcategories":[]},
    {"id":"nail","label":"Nail care","subcategories":[]}
  ]'::jsonb,
...
begin
  ...
  for line in select * from jsonb_array_elements(p_items) loop
    ...
    where id = (line ->> 'variant_id')::uuid
      and stock >= (line ->> 'quantity')::integer;
